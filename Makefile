...
INCPATH       = -I. -Iinclude -I/home/i7679227/NGL/include -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtGui -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -I. -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = game1.0.0
DISTDIR = /home/i7679227/SmallBlurryPeopleCVA3/obj/game1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/i7679227/NGL/lib -Wl,-rpath,/opt/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -L/home/i7679227/NGL/lib -l NGL -ltiff -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = obj/main.o \
		obj/Scene.o
DIST          = .qmake.stash \
		game.pro include/Scene.hpp src/main.cpp \
		src/Scene.cpp
QMAKE_TARGET  = game
DESTDIR       = 
TARGET        = game
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Scene.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Scene.cpp $(DISTDIR)/
...
obj/main.o: src/main.cpp /home/i7679227/NGL/include/ngl/Vec3.h \
		/home/i7679227/NGL/include/ngl/Types.h \
		/home/i7679227/NGL/include/ngl/glew.h \
		...
		/home/i7679227/NGL/include/ngl/NGLStream.h
