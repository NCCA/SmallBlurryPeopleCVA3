...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Scene.hpp include/Camera.hpp include/Grid.hpp include/Character.hpp include/Prop.hpp include/Node.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Scene.cpp src/Camera.cpp src/Grid.cpp src/Character.cpp src/Prop.cpp src/Node.cpp $(DISTDIR)/
