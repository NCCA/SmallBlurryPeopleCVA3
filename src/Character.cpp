	...
	m_wood_inventory(0)
{
	...
	std::uniform_int_distribution<int> fishing_speed(5,10);
	m_fishing_speed = fishing_speed(mt_rand);

	std::uniform_int_distribution<int> fishing_catch(1,5);
	m_fishing_catch = fishing_catch(mt_rand);
